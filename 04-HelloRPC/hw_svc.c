...
{
	union {
		char *getmessages_1_arg;
		packet sendmessage_1_arg;
		char *connect_1_arg;
	} argument;
	char *result;
	...
	case getMessages:
		...
		_xdr_result = (xdrproc_t) xdr_sPacket;
		local = (char *(*)(char *, struct svc_req *)) getmessages_1_svc;
		break;

	case sendMessage:
		_xdr_argument = (xdrproc_t) xdr_packet;
